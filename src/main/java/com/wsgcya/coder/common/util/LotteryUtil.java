 ...
 *         1.输入抽奖概率集合，【抽奖概率集合为{10.0, 20.0, 30.0}】 2.生成连续集合， 【生成的连续集合为{(0.0,
 *         10.0],(10.0, 30.0],(30.0, 60.0]}】 3.生成随机数， 【生成方法为 random.nextDouble()
 *         * maxElement】 4.判断随机数在哪个区间内，返回该区间的index【生成了随机数12.001，则它属于(10.0,
 *         30.0]，返回 index = 1】
 * 
 */
