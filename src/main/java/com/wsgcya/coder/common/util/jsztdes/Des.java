...
//wx.go189.cn加解密：Des.encode(pwdAdd);
public class Des {
    ...
    public static String decode(String str){
        return getDes().strDec(str, KEY_1, KEY_2, KEY_3);
    }
    ...
    public static String encode(String str){
    	return getDes().strEnc(str, KEY_1, KEY_2, KEY_3);
    }
    ...
    public String strEnc(String data, String firstKey, String secondKey,
        ...
        if (leng > 0) {
            if (leng < 4) {
                int[] bt = strToBt(data);
                int[] encByte = null;
                if (firstKey != null && !"".equals(firstKey) && secondKey != null
                        && !"".equals(secondKey) && thirdKey != null
                        && !"".equals(thirdKey)) {
                    int[] tempBt;
                    int x, y, z;
                    tempBt = bt;
                ...
                for (i = 0; i < iterator; i++) {
                    ...
                    if (firstKey != null && !"".equals(firstKey) && secondKey != null
                        ...
                        if (firstKey != null && !"".equals(firstKey)
                                && secondKey != null && !"".equals(secondKey)) {
                            int[] tempBt;
                            int x, y;
                            tempBt = tempByte;
                            for (x = 0; x < firstLength; x++) {
    ...
    public String strDec(String data, String firstKey, String secondKey,
        ...
        for (i = 0; i < iterator; i++) {
            ...
            int[] decByte = null;
            if (firstKey != null && !"".equals(firstKey) && secondKey != null
                    && !"".equals(secondKey) && thirdKey != null && !"".equals(thirdKey)) {
                int[] tempBt;
                int x, y, z;
                tempBt = intByte;
     ...
     * @return
     */
    public static String encrypt(String sourceTxt, String password) {
        try {
            byte[] datasource = sourceTxt.getBytes();
            ...
            //现在，获取数据并加密
            //正式执行加密操作
            return bytesToHexString(cipher.doFinal(datasource));
        } catch (Throwable e) {
            e.printStackTrace();
        }
        return null;
